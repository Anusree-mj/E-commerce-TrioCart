        ...
        if (result.status === 'ok') {
            ...
            cartHelpers.getMyCartProducts(userId).then((result) => {
                if (result) {
                    ...
                    res.render('customers/home', { layout: 'layout/layout', products, allCategories, user: user, totalCartProduct });
                }
            })
        } else {
            res.render('customers/home', { layout: 'layout/layout', products, allCategories, user: undefined });
        }
    });
}
